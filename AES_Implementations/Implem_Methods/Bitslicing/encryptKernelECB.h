...
size_t inputSize)
{
    ...
    for(int i = global_tid; i < elements; i += gridSize) {
        ...
        for (int i = 1; i < 10; i++) {
            ...
            //Mixcolums & shiftrow steps 
            //Shiftrows correspond to the parameters order
            KeyMixcl(r0  , r1  , r2  , r3  , r4  , r5  , r6  , r7  ,
            ...
            KeyMixcl(r8  , r9  , r10 , r11 , r12  , r13  , r14  , r15  ,
            ...
            KeyMixcl(r16 , r17 , r18 , r19 , r20  , r21  , r22  , r23  ,
            ...
            KeyMixcl(r24 , r25 , r26 , r27 , r28  , r29  , r30  , r31  ,
        ...
        // Second Row
        temp0 = r32^sm_key[1336];
        temp1 = r33^sm_key[1337];
        temp2 = r34^sm_key[1338];
        temp3 = r35^sm_key[1339];
        temp4 = r36^sm_key[1340];
        temp5 = r37^sm_key[1341];
        temp6 = r38^sm_key[1342];
        temp7 = r39^sm_key[1343];
        r32   = r40^sm_key[1312];
        r33   = r41^sm_key[1313];
        r34   = r42^sm_key[1314];
        r35   = r43^sm_key[1315];
        ...
        r63   = temp7;
        //Third row
        temp0 = r64^sm_key[1360];
        temp1 = r65^sm_key[1361];
        temp2 = r66^sm_key[1362];
        temp3 = r67^sm_key[1363];
        temp4 = r68^sm_key[1364];
        temp5 = r69^sm_key[1365];
        temp6 = r70^sm_key[1366];
        temp7 = r71^sm_key[1367];
        r64   = r80^sm_key[1344];
        r65   = r81^sm_key[1345];
        r66   = r82^sm_key[1346];
        r67   = r83^sm_key[1347];
        ...
        r86   = temp6;
        r87   = temp7;
        temp0 = r72^sm_key[1368];
        temp1 = r73^sm_key[1369];
        temp2 = r74^sm_key[1370];
        temp3 = r75^sm_key[1371];
        temp4 = r76^sm_key[1372];
        temp5 = r77^sm_key[1373];
        temp6 = r78^sm_key[1374];
        temp7 = r79^sm_key[1375];
        r72   = r88^sm_key[1352];
        r73   = r89^sm_key[1353];
        r74   = r90^sm_key[1354];
        r75   = r91^sm_key[1355];
        ...
        r95   = temp7;
        //Last row
        temp0 = r96 ^sm_key[1384];
        temp1 = r97 ^sm_key[1385];
        temp2 = r98 ^sm_key[1386];
        temp3 = r99 ^sm_key[1387];
        temp4 = r100^sm_key[1388];
        temp5 = r101^sm_key[1389];
        temp6 = r102^sm_key[1390];
        temp7 = r103^sm_key[1391];
        r96   = r120^sm_key[1376];
        r97   = r121^sm_key[1377];
        r98   = r122^sm_key[1378];
        r99   = r123^sm_key[1379];
        r100  = r124^sm_key[1380];
        r101  = r125^sm_key[1381];
        r102  = r126^sm_key[1382];
        r103  = r127^sm_key[1383];
        r120  = r112^sm_key[1400];
        r121  = r113^sm_key[1401];
        r122  = r114^sm_key[1402];
        r123  = r115^sm_key[1403];
        r124  = r116^sm_key[1404];
        r125  = r117^sm_key[1405];
        r126  = r118^sm_key[1406];
        r127  = r119^sm_key[1407];
        r112  = r104^sm_key[1392];
        r113  = r105^sm_key[1393];
        r114  = r106^sm_key[1394];
        r115  = r107^sm_key[1395];
        r116  = r108^sm_key[1396];
        r117  = r109^sm_key[1397];
        r118  = r110^sm_key[1398];
        r119  = r111^sm_key[1399];
        r104  = temp0;
        r105  = temp1;
        r106  = temp2;
        r107  = temp3;
