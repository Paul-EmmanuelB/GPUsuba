...
unsigned commandLineManager(int argc, char *argv[]) {
	...
	//Calculation of pairs input | key. It's why we substract parameters about
	// the function name , <e|d> and <128|256> .
...
//Reverse expension of the key for decryption purpose
